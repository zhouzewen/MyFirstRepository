...
@interface ZZW_SuspendBallButton()
@end


@implementation ZZW_SuspendBallButton
+(instancetype)sharedInstance{
    static ZZW_SuspendBallButton * buttonInstance = nil;
...
{
    ZZW_SuspendBallButton *suspendBall = [[ZZW_SuspendBallButton alloc] initWithFrame:ballFrame];
    suspendBall.delegate = delegate;

    if ([UIImage imageWithContentsOfFile:path]) {
        [suspendBall setImage:[UIImage imageWithContentsOfFile:path] forState:UIControlStateNormal];
    }else{
       [suspendBall setImage:[UIImage imageNamed:path] forState:UIControlStateNormal];
    }
